...
for f in files:
    ...
    if pos < 700:
        dest_folder = '/Users/gastoncrecikeinbaum/Documents/Data Science/Courses/PyTorch/PyTorch-course/075_ObjectDetection_Yolo7/yolov7/train'  # Changed from 'yolov7\\train'
    elif (pos >= 700 and pos < 800):
        dest_folder = '/Users/gastoncrecikeinbaum/Documents/Data Science/Courses/PyTorch/PyTorch-course/075_ObjectDetection_Yolo7/yolov7/val'    # Changed from 'yolov7\\val'
    else:
        dest_folder = '/Users/gastoncrecikeinbaum/Documents/Data Science/Courses/PyTorch/PyTorch-course/075_ObjectDetection_Yolo7/yolov7/test'   # Changed from 'yolov7\\test'
